...
public class Manual extends StartingSub {
	...
	public void tutorial() {
		...
		System.out.println("제임스 아저씨 : (한숨 푹)");
		System.out.println(name + ": " + talkSub + "?.? 아저씨, 무슨 일 있으세요?" + talkSub);
		System.out.println("제임스 아저씨 : " + talkSub + "코로나로 인해 내 피자가게가 망하겠어...ㅠㅠ" + talkSub);
		System.out.println(name + ": " + talkSub + "음.. 제가 장사가 잘 되도록 도와드릴게요!" + talkSub);
		System.out.println("제임스 아저씨 : " + talkSub + "오! 그렇담, " + name + "! 이 피자가게의 주인은 너로 정했다!" + talkSub);
